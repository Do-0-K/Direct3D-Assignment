...
void CCamera::UpdateShaderVariables(ID3D12GraphicsCommandList* pd3dCommandList)
{
	...
	XMStoreFloat4x4(&m_xmf4x4InverseView, XMMatrixTranspose(XMLoadFloat4x4(&m_xmf4x4Projection)));
	::memcpy(&m_pcbMappedCamera->m_xmf4x4InverseView, &m_xmf4x4InverseView, sizeof(XMFLOAT4X4));
