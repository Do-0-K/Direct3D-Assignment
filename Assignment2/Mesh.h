...
public:
	...
	virtual void Renders(ID3D12GraphicsCommandList* pd3dCommandList, int nPipelineState) { };
...
{
public:
	CubeMesh(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, float fWidth = 0.5f, float fHeight = 0.5f, float fDepth = 0.5f);
	virtual ~CubeMesh();
};
